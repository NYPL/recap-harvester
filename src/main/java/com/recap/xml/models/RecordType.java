...
public class RecordType {
   ...
   * there is not a <CODE>set</CODE> method for the controlfield property.
   * <p/>
   * <p/>
   ...
   * <p/>
   * <p/>
   * Objects of the following type(s) are allowed in the list {@link ControlFieldType }
   */
   ...
   * <p/>
   * <p/>
   * Objects of the following type(s) are allowed in the list {@link DataFieldType }
   */
